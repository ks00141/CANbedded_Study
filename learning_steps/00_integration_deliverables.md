...
| 4 | HS-CAN Driver, mock HAL, SPC58xC HAL adapter interface | IL/TP/NM/CCL의 하위 송수신 API |
...
- `SPC58xC` 파생품별 CAN-FD 지원 controller 수가 다르므로 HAL adapter는 controller instance를 설정으로 받는다.
...
3. SPC58xC 보드에서 CAN controller loopback을 확인한다.
